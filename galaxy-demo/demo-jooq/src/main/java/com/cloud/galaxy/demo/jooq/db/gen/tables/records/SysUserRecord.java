...
public class SysUserRecord extends UpdatableRecordImpl<SysUserRecord> implements Record5<Long, String, LocalDate, LocalDateTime, BigDecimal> {
    ...
    @Override
    public Row5<Long, String, LocalDate, LocalDateTime, BigDecimal> valuesRow() {
    ...
    @Override
    public SysUserRecord values(Long value1, String value2, LocalDate value3, LocalDateTime value4, BigDecimal value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SysUserRecord(Long id, String name, LocalDate birth, LocalDateTime createTime, BigDecimal balance) {
        super(SysUser.SYS_USER);
